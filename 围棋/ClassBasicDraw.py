...
class game_draw():#建立游戏绘制对象
    ...
    def basic_draw(self):
        ...
        if (th == 18):
            ...
            self.draw_circle((self.start + 9 * self.grid_wide, self.start + 3 * self.grid_wide))
            self.draw_circle((self.start + 15 * self.grid_wide, self.start + 3 * self.grid_wide))
            self.draw_circle((self.start + 3 * self.grid_wide, self.start + 9 * self.grid_wide))
            self.draw_circle((self.start + 9 * self.grid_wide, self.start + 9 * self.grid_wide))
            self.draw_circle((self.start + 15 * self.grid_wide, self.start + 9 * self.grid_wide))
            self.draw_circle((self.start + 3 * self.grid_wide, self.start + 15 * self.grid_wide))
            self.draw_circle((self.start + 9 * self.grid_wide, self.start + 15 * self.grid_wide))
            self.draw_circle((self.start + 15 * self.grid_wide, self.start + 15 * self.grid_wide))
